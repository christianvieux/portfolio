...
export default function SwitchComponent({isDarkMode, setIsDarkMode, onChange, ...props}) {
  const [mounted, setMounted] = useState(false);
  // Initialize dark mode based on system preference or stored value
  const handleDarkModeToggle = (toggle) => {
  ...
  //! Ensure the component is mounted before rendering. Needed to prevent hydration mismatch
  useEffect(() => {
    setMounted(true);
  }, []);
