    ...
    modal: {
      ...
      libraries: [
        ...
        },
        {
          ...
          items: [".NET Core Web API", "Entity Framework Core", "AWS SDK"],
        },
      ],
      infrastructure: [
        {
          category: "AWS Services",
          items: ["S3 for file storage", "DynamoDB for metadata", "IAM for security management"],
        },
        {
          category: "Security",
          items: ["JWT authentication", "File access control", "Secure file transfer"],
        },
      ],
    },
